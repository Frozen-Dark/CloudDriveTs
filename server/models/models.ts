...
const User: ModelStatic<Model<UserAttributes, UserCreationAttributes>> = sequelize.define("user", {
...
const Folder: ModelStatic<Model<FolderAttributes, FolderCreationAttributes>> = sequelize.define("folder", {
    id: {type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true},
...
const File: ModelStatic<Model<FileAttributes, FileCreationAttributes>> = sequelize.define("file", {
    id: {type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true},
    userId: {type: DataTypes.INTEGER, references: {model: User, key: "id"}},
...
const Token: ModelStatic<Model<TokenAttributes, TokenCreationAttributes>> = sequelize.define("token", {
    id: {type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true},
    userId: {type: DataTypes.INTEGER, references: {model: User, key: "id"}},
...
const SharedLink: ModelStatic<Model<SharedLinkAttributes, SharedLinkCreationAttributes>> = sequelize.define("sharedLink", {
    id: {type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true},
...
const SharedLinkUsers: ModelStatic<Model<SharedLinkUsersAttributes, SharedLinkUsersCreationAttributes>> = sequelize.define("sharedLinkUsers", {
    id: {type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true},
    userId: {type: DataTypes.INTEGER, references: {model: User, key: "id"}},
